export const getDriverDocuments = state => state.documents.driver
export const getManagerDocuments = state => state.documents.manager
export const getAdrDocuments = state => state.documents.adr
