...
const Preview = (
    { id, firstname, lastname, parentname, from, to, size, birthdate },
    ref
) => {
    ...
    return (
        <>
            {isCurrentDateValid() && (
                <div
                    className={`preview__status ${certificateStatus.toLowerCase()}`}
                >
                    {' '}
                    {certificateStatus}
                </div>
            )}
            {!id.startsWith('0') && !id.startsWith('T') ? (
                <div id="pdf" ref={ref} className="certificate-container">
                    <div className="certificate-wrapper">
                        <div className="certificate-left">
                            <img
                                className="certificate-gerb"
                                src={gerb}
                                alt=""
                            />
                        ...
                        >
                            ...
                            <div className="certificate__bottom">
                                ...
                                ga haqiqatdan ham milliy va xalqaro avtomobilda
                                yuk tashish bo`yicha №1071/2009 sonli EC
                                derektivasi va milliy me'yoriy xujjatlarga
                                asoslangan maxsus kursda o`qidi va malakaviy
                                imtixon topshirdi.
                                <br />
