...
const DriverCertificate = forwardRef(
    ({ id, firstname, lastname, parentname, from, to }, ref) => {
                            ...
                            <div className="pdf_mainSection">
                                ...
                                <div className="pdf_content">
                                    ...
                                    <p className="pdf_mchjDesc">
                                        (Malaka oshirish ta'lim muassasasining
                                        nomi)
                                    </p>
                                    ...
                                    <div className="additional_partner">
                                        <p>
                                            ...
                                            milliy me'yoriy xujjatlarga
                                            asoslangan maxsus kursda o`qidi va
                                            malakaviy imtixon topshirdi.
                                        </p>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div className="pdf_content">
                                    ...
                                    <div className="additional_partner">
                                        <p>
                                            ...
                                            прошел обучение по данному курсу,
                                            основанному национальным
                                            требованиям, и успешно сдал
                                            экзамены.
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div className="pdf_langContainer">
                                <div className="pdf_langRu">
                                    ...
                                    <p className="pdf_langOrganization">
                                        ...
                                        международных перевозок автомобильным
                                        транспортом "
                                    </p>
                                ...
                                <div className="pdf_langEng">
                                    ...
                                    <p className="pdf_langOrganization">
                                        ...
                                        international automobile transportation
                                    </p>
