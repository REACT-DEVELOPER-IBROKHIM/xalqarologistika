    ...
    <div className="pdf_driver">
        ...
        <div className="adr__container" ref={ref}>
          <div className="adr_card"  >
            <h2 className="adr_englishtitle">ADR-DRIVER TRAINING CERTIFICATE</h2>
            <h3 className="adr_rustitle">СВИДЕТЕЛЬСТВО О ПОДГОТОВКЕ ВОДИТЕЛЯ ПО ДОПОГ</h3>
            <div className="adr_maintop">
              <div className="uz_wrapper">UZ</div>
              <p className="main__bold">1.<span className="smaller_text">Nr.{id}</span></p>
              <h2 className="adr_logo">NT2022</h2>
            </div>
            <div className="adr_maincenter">
              <div className="center__image"></div>
              <div className="center__info">
              <p className="main__bold">2. <span className="smaller_text">{firstname}</span></p>
              <p className="main__bold">3. <span className="smaller_text">{lastname}</span></p>
              <p className="main__bold">4. <span className="smaller_text"> {birthdate} </span></p>
              <p className="main__bold">5. <span className="smaller_text"> REPUBLIC OF UZBEKISTAN</span></p>
              <p className="main__bold">6. <span className="smaller_text">NAMANGANTRANS 2022</span></p>
              <p className="main__bold">7. <span  className="smaller_text">Until (date) {to}</span></p>
         ...
         <div className="adr_cardback">
            ...
            <h3 className="back__smalltitle">ДЕЙСТВИТЕЛЬНО В ОТНОШЕНИИ ВЕЩЕСТВ КЛАССА(ОВ) ИЛИ № ООН</h3>
            <table>
              <tr>
                <th>9. In tank</th>
         ...
         <div className="pdf_lang">
            <div className="pdf_langSertificate">
              ...
              <div className="pdf_langSertificateContent">
                ...
                <h2 className="pdf_langSerContName">ADR Sertifikat</h2>
