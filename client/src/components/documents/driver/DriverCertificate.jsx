                            ...
                            <div className="pdf_content">
                                ...
                                <div className="additional_partner">
                                    <p>
                                        ...
                                        avtomobilda yuk tashish bo`yicha milliy
                                        me'yoriy xujjatlarga asoslangan maxsus
                                        kursda o`qidi va malakaviy imtixon
                                        topshirdi.
                                    </p>
                                </div>
                            </div>
                        ...
                        <div className="pdf_mainSection">
                            ...
                            <div className="pdf_content">
                                ...
                                <h1 className="pdf_titleDRu">
                                    ...
                                    НАЦИОНАЛЬНЫМ И МЕЖДУНАРОДНЫМ АВТОМОБИЛЬНЫМ
                                    ПЕРЕВОЗКАМ ГРУЗОВ
                                </h1>
                                <h2 className="pdf_id">MO № {id}</h2>
                                <h2 className="pdf_userName">
                                ...
                                <div className="additional_partner">
                                    <p>
                                        ...
                                        основанному национальным требованиям, и
                        ...
                        <div className="pdf_langContainer">
                            <div className="pdf_langRu">
                                ...
                                <p className="pdf_langOrganization">
                                    " Организация по осуществлению международных
                            ...
                            <div className="pdf_langEng">
                                ...
                                <p className="pdf_langNameDesc">
                                    This certificate that he completed training
                                    course on special program
                                </p>
                                <p className="pdf_langOrganization">
