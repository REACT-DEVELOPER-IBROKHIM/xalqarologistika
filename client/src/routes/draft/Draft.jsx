                        ...
                        <div className="pdf_content">
                            ...
                            {id.startsWith('M') ? (
                                <p className="additional">
                                    Avtomobil transportida yuk va yo'lovchilar
                                    tashish bilan shug'ullanayotgan yuridik
                                    shaxslarning rahbarlari va mas'ul
                                    xodimlarining malakasini oshirish
                                </p>
                            ) : (
                                <></>
                            )}
                            <h2 className="pdf_mchj">
                            ...
                            <div className="additional_partner">
                                <p>
                                    ...
                                    avtomobilda yuk tashish bo`yicha №1071/2009
                                    sonli EC derektivasi va milliy me'yoriy
                                    xujjatlarga asoslangan maxsus kursda o`qidi
                                    va malakaviy imtixon topshirdi.
                                </p>
                        ...
                        <>
                            <div className="pdf_lang">
                                <div className="pdf_langContainer">
                                    <div className="pdf_langRu">
                                        ...
                                        <h4>
                                            на осуществление международных
                                            автомобильных перевозов
                                        </h4>
                                        ...
                                        <p className="pdf_langNameDesc">
                                            О том что он прошел курс обучения по
                                        ...
                                        <h4 className="pdf_langDirector">
                                            {' '}
                                            Директор: OOO "NAMANGANTRANS 2022"
                                            Bahrom Muhiddinov
                                        </h4>
                                    </div>
                                    <div className="pdf_langEng">
                                        ...
                                        <p className="pdf_langNameDesc">
                                            This certificate that he completed
                                            training course on special program
                                        </p>
                                        <p className="pdf_langOrganization">
                                        ...
                                        <h4 className="pdf_langDirector">
                                            {' '}
                                            Director: OOO "NAMANGANTRANS 2022"
                                            Bahrom Muhiddinov
                                        </h4>
                                    </div>
                                </div>
                            ...
                            <div className="certficate-text__container">
                                ...
                                <h4>
                                    ...
                                    <br></br>
                                    (СПК) международного автомобильного
                                    перевозчика
                                </h4>
                                <br />
                                <br />
                                ...
                                <p>
                                    квалификационный экзамен({from}) на
                                    профессиональную компетентность и признан(а)
                                    квалифицированным(ой) для профессиональной
                                    работы в качестве Водителя
                                    <br />
                                    <br />
                                    <i>
                                        По программе: Повышение квалификации
                                        водителей, занимающихся международными
                                        автомобильными перевозками
                                    </i>
                                    Выдано: {from}
                                    Действителен до: {to}
                                    по повышения квалификации и переподготовки
                                    кадров автомобильного транспорта
                                </p>
                                ...
                                <p>
                                    qualifying exam({from}) for professional
                                    competence and recognized as qualified for
                                    professional work as Driver
                                    <br />
                                    <br />
                                    <i>
                                        According to the program: Advanced
                                        training drivers involved in
                                        international road transport
                                    </i>
                                    Issued: {from}
                                    Valid until: {to}
                                    for advanced training and retraining of
                                    automotive personnel transport
                                </p>
                            </div>
                        </>
                    ) : (
                ...
                <div className="adr__container">
                    ...
                    <div className="adr_cardback">
                        ...
                        <h3 className="back__smalltitle">
                            ДЕЙСТВИТЕЛЬНО В ОТНОШЕНИИ ВЕЩЕСТВ КЛАССА(ОВ) ИЛИ №
                            ООН
                        </h3>
                        <table>
                            <tr>
                                ...
                                <div className="pdf_langContainer">
                                    <div className="pdf_langRu">
                                        ...
                                        <p className="pdf_langOrganization">
                                            ...
                                            компетентности в области Перевозка
