    ...
    <div className="darft_container drafted">
      ...
      {id.startsWith("D") || id.startsWith("M") ? (
        <div className="pdf_container ">
          <div className={`draft_text ${certificateStatus.toLowerCase()}`}>
            {
              <>

              {
                new Array(id?.includes("D") ? 8 : 4).fill(0).map((_, index) => (
                  <h1 className={certificateStatus.toLowerCase()} key={index}>{certificateStatus}</h1>
                ))
              }
              </>
            }
            ...
            <>
              ...
              <div className="certficate-text__container">
                ...
                <p>
                  ...
                  <br />
                  <i>
                    По программе: Повышение квалификации водителей, занимающихся
                ...
                <p>
                  ...
                  <br />
                  <i>
                    According to the program: Advanced training drivers involved
          ...
          <div className="adr_card">
            ...
            <div className="adr_maincenter">
              ...
              <div className="center__info">
                ...
                <p className="main__bold">
                  5.{" "}
                  <span className="smaller_text"> REPUBLIC OF UZBEKISTAN</span>
                </p>
                <p className="main__bold">
              ...
              <div className="pdf_lang">
                <div className="pdf_langContainer">
                  ...
                  <div className="pdf_langEng ">
                    ...
                    <p className="pdf_langOrganization">
                      Certificate of Professional Competence in the Transport of
